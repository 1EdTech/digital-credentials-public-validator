...
public class VelocityNetworkTests {
    ...
    private static byte[] version = CryptoUtils.hexToBytes("0x6b86");
    ...
    void testHexConversion() {
        ...
        Assertions.assertEquals("6b86", CryptoUtils.bytesToHex(CryptoUtils.hexToBytes("0x6b86")));
    }

    @Test
    void test2BytesHex() {
        Assertions.assertEquals("6b86", CryptoUtils.get2BytesHash("1"));
        Assertions.assertEquals("2936", CryptoUtils.get2BytesHash("OpenBadgeCredential"));
    }

    @Test
    void testKeyDerivation() {
        String credentialDID2 = "did:velocity:v2:0x72177016fd2547403e9fe3409c3fcdcaee0831a6:142420761584332:3634:751347bfd23481074ad4aa6abe9152a3bda15292c8f6fea68a28c1fde065949c";
        List<Tuple<VelocityNetworkMetadataRegistry.CredentialIdentifier, String>> parsedDid = VelocityNetworkDidResolver.parseVelocityV2Did(credentialDID2);
        Assertions.assertEquals(CredentialMetadataKDF.derive(parsedDid.get(0).t2), "01fcffbb6917fe2e1e09e9db00c2bb04dd24266b468e204aeebc3bda54df13c7");
    }
