...
public class Bbs2023DataIntegrity extends DataIntegrityProof {
	...
	public static Builder<? extends Builder<?>> builder() {
		return new Builder(new Bbs2023DataIntegrity());
	}
	...
	public static class Builder<B extends Builder<B>> extends DataIntegrityProof.Builder<B> {
		...
		public DataIntegrityProof build() {
			...
			if (addCryptosuite) {
				JsonLDUtils.jsonLdAdd(this.jsonLdObject, "cryptosuite", "bbs-2023");
			}
